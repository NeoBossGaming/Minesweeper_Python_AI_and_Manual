...
def runGame(difficulty):
    ...
    while True:
        ...
        if isFound == True:
            ...
            if checkWin(controller, controller.showBoard(), controller.playBoard.completeBoard):
                return True
            else:
...
def checkWin(controller, playBoard, completeBoard):
    ...
    for y in range(controller.playBoard.yDimen):
        for x in range(controller.playBoard.xDimen):
            if playBoard[y][x] == completeBoard[x][y]:
                continue
            elif playBoard[y][x] == "F" and completeBoard[x][y] == "9":
               continue
            else:
